...
PROCESSED_DIR = PROJECT_ROOT / "data" / "wheat_detector_dataset"
MODEL_PATH = PROJECT_ROOT / "models" / "wheat_detector" / "best_wheat_detector_model.keras"

# optional: where to save outputs
OUTPUT_DIR = PROJECT_ROOT / "models" / "wheat_detector" / "evaluation"
...
def main():
    ...
    np.savetxt(OUTPUT_DIR / "stage1_confusion_matrix.csv", cm, delimiter=",", fmt="%d")

    # optional: print TP/TN/FP/FN explanation
